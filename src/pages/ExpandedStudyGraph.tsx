...
const ExpandedStudyGraph = () => {
  ...
  const sortedEntries = Object.entries(studyData).sort(([a], [b]) => a.localeCompare(b));
      ...
      <div className="max-w-7xl mx-auto">
        <div className="glass-card rounded-xl p-8">
          <h1 className="text-3xl font-bold mb-8 flex items-center gap-3">
            <span className="text-primary">📚</span> Study Time (Hours) - Expanded View
          </h1>
...
export default ExpandedStudyGraph;
